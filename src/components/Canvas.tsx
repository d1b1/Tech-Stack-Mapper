...
interface CanvasProps {
  ...
  onNodeSelect: (id: string | null, isEmptySpace: boolean) => void;
    ...
    >
      <Layer>
        ...
        {connections.map((connection) => {
          ...
          const lineColor = connection.lineColor || (isSelected ? "#3b82f6" : "#666");
          const lineWidth = connection.lineWidth || (isSelected ? 3 : 2);
          const lineDash = connection.lineDash || [5, 5];
          ...
          return (
            ...
            >
              ...
              {/* Invisible hit area to make connection selection easier */}
              {!isSelected && (
                <Path
                  data={pathData}
                  stroke="transparent"
        ...
        {nodes.map((node) => (
          <Node
            ...
            onClick={() => onNodeSelect(node.id, false)}
          />
        ))}
      </Layer>
    </Stage>
